    ...
    <div class="container mx-auto max-w-md relative z-10">
        ...
        <div class="login-card p-8 animate-fadeInUp backdrop-blur-sm bg-white/95">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold text-[#1A0046] mb-2">Nueva Contraseña</h2>
                <p class="text-[#32004E] opacity-70">Ingresa tu nueva contraseña</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.reset') }}">
                ...
                <div class="mb-6">
                    <label for="password" class="block text-[#1A0046] font-medium mb-2">Nueva contraseña</label>
                    <div class="relative">
                ...
                <div class="mb-6">
                    <label for="password_confirmation" class="block text-[#1A0046] font-medium mb-2">Confirmar nueva contraseña</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
                ...
                <div class="text-center text-sm text-[#32004E] opacity-70">
                    ¿Recordaste tu contraseña? <a href="{{ route('login') }}" class="text-[#1A0046] font-semibold hover:underline">Inicia sesión</a>
                </div>
            </form>
        </div>
    </div>
