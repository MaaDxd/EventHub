    ...
    <div class="max-w-md w-full space-y-8">
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Registro de Creador</h2>
                <p class="text-gray-600">Crea tu cuenta para organizar eventos</p>
            </div>
            ...
            <form method="POST" action="{{ route('register.creator') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="phone" name="phone" type="tel" required 
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1A0046] focus:border-transparent transition-colors @error('phone') border-red-500 @enderror"
